/*
 * Share struct definitions between two contexts. The struct
 * is self-referential in a way that mimics Perl's sv struct.
 */
...
"    SV * pt = malloc(sizeof(SV));\n"
"    pt->x = x;\n"
"    pt->yval = newy;\n"
"    pt->sv_u.next_offset = 0;\n"
"    return pt;\n"
"}\n"
;

char second_code[] =
"int sq_distance_to_pt(SV * pt) {\n"
